...
#### 2026-07-17 (run 20260717-134250-jt3ix2)
1. MainScreen の初期マウントを確認
2. POST /api/automator/reset `{"before":{"deletedInstances":1,"deletedReports":0}}`
3. MainScreen をリロードし、再マウントを確認
4. study-row-* の件数を確認 `{"count":0}`
Result: PASS — reset結果: {"deletedInstances":1,"deletedReports":0}
