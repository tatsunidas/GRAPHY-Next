...
| A4 QCA | **CADICA**（Mendeley Data、42 患者・350 ビデオ、各 10 連続フレーム、狭窄 bbox・重症度 3 区分） | PNG（元は DICOM） | ✅ **CC BY 4.0**（2026-08-27 確認。**出典表記が必須**） | %DS 区分との定性一致、時系列（造影充満）挙動 |
...
| **CADICA**（Mendeley `p9bpx9ctcv`） | **CC BY 4.0** | ✅ 出典表記必須 | PNG 512²・42 患者 350 ビデオ × 10 連続フレーム |
...
| データ | 束ね方 | 解析 |
| :- | :- | :- |
| **CADICA**（1 ビデオ = 10 連続フレーム） | マルチフレーム | ✅ できる |
