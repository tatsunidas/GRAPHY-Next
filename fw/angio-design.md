...
> A5a・A5c・A6b・A7・A8・A11・A12・A13-3 は未着手**
>
> **実機検証の到達点（合計 410 項目）**: A1 シネ 31 ／ A2 DSA 18 ／ A3 校正 11 ／
> A4+A10 QCA 20 ／ A4 手修正 34 ／ A9 RDSR 18 ／ **A4b ファントム 67（退行 0・設計目標に未達 17）**
> ／ **A13-1 ステップ・レール 30** ／ **A5b QLV 44** ／ **A6a 3D QCA 103（未達 2）** ／
> **A14 レポート統合 15** ／ **A13-2 タスク・ランチャー 19**。
...
（**A13-1・A5b・A14・A6a・A13-2 まで完了**。次は A5a）:
...
| 3 | **未実装は他の条件が揃っていても「未対応（フェーズ A5a）」** | 直せない理由を先に出す（下記） |
