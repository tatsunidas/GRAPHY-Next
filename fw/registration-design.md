...
> 起票: 2026-08-08 ／ ステータス: **R1〜R5 実装・実機検証済み（2026-08-09）／ R6 以降 未着手**
> 　残件: SRO の UI 導線（codec と REST は完了）、マルチモーダル剛体の回転精度（下記 §9.4 注記）
...
| 第 2 段 | **DICOM SRO**（66.1 / 66.3）＝ R5 | 🟡 codec・REST は実装済み・実データ往復確認済み。**UI 導線が未着手** |
